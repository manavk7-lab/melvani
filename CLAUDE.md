...
- OAuth: Web client with origin `https://manavk7-lab.github.io` and redirect `https://manavk7-lab.github.io/melvani/`. Its ID goes in `CONFIG.CLIENT_ID` in index.html (empty → demo mode; `?demo` forces demo).
